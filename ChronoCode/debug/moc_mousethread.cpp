/****************************************************************************
** Meta object code from reading C++ file 'mousethread.h'
**
...
#include "../../MainScreen/mousethread.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'mousethread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 9), // "MouseSlot"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "MouseThread\0MouseSlot\0"
};
...
void MouseThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MouseThread *_t = static_cast<MouseThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->MouseSlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject MouseThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MouseThread.data,
      qt_meta_data_MouseThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MouseThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MouseThread.stringdata0))
        return static_cast<void*>(const_cast< MouseThread*>(this));
